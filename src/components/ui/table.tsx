...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
  return (
    <thead
      ...
      className={cn(
        '[&_tr]:bg-transparent hover:[&_tr]:bg-transparent',
        className
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        'hover:bg-foreground/10 bg-foreground/5 data-[state=selected]:bg-muted transition-colors [&_td:first-child]:rounded-l-lg [&_td:last-child]:rounded-r-lg',
        className
      )}
      {...props}
    />
